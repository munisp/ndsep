...
export default function OfflinePaymentScreen() {
  ...
  function submit() {
    ...
    submitPayment.mutate({ reference: reference.trim(), amountKobo, service: service.trim(), evidenceDescription: evidenceDescription.trim() });
  }
