...
export type PendingStakeholderSyncItem = { id: string; idempotencyKey: string; kind: StakeholderSyncKind; label: string; queuedAt: string; status: StakeholderSyncStatus; retryCount: number; payloadPath: string; lastErrorCode?: "transport_failed" | "payload_decryption_failed" | "replay_rejected" };
