...
// expo-image: disk+memory caching and view-recycling for attachment thumbs
// (RN Image re-decodes on every render pass and caches nothing on Android).
