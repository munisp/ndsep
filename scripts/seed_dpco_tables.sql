-- ============================================================
-- NDSEP DPCO + Remaining Tables Seed Script
-- ============================================================
...
(2,4,'Jumia E-Commerce Privacy Audit','planning',65,'Bisi Okafor','2026-04-15','2026-05-31',NULL,NULL,0,0,0,0,'Audit planning underway',NOW()-INTERVAL '14 days'),
...
SELECT 'DPCO seed complete' AS status;
