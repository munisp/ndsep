...
export type KeycloakDirectorySession = { subject: string; username: string; sessionId: string; lastAccessAt: string | null; sourceAddress: string | null };
