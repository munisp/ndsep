...
import { MAX_OFFLINE_ATTACHMENTS_PER_MANIFEST, MAX_OFFLINE_ATTACHMENT_BYTES, MAX_OFFLINE_MANIFEST_BYTES } from "../lib/offline-field-attachment-policy";
...
describe("offline field attachment limits", () => {
  it("defines bounded offline storage limits for field evidence", () => {
    ...
    expect(MAX_OFFLINE_MANIFEST_BYTES).toBe(50 * 1024 * 1024);
  });
});
