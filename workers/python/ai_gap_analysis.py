...
class AIGapAnalysis(WorkerBase):
    ...
    def _check_area(self, cur, org_id: int, area: str, req: Dict) -> List[ComplianceGap]:
        ...
        if area == "registration":
            ...
            if not row or row[0] != "approved":
                gaps.append(
                    ComplianceGap(
                        ...
                        action_items=[
                            "Complete NDPC registration form",
                ...
                gaps.append(
                    ComplianceGap(
                        ...
                        action_items=[
                            ...
                            "Conduct DPIA using NDSEP wizard",
            ...
            cur.fetchone()[0] >= 0  # Having the table means they're aware
                ...
                gaps.append(
                    ComplianceGap(
                        ...
                        action_items=[
                            ...
                            "Define 72-hour notification workflow",
            ...
            if dsar_count == 0:
                gaps.append(
                    ComplianceGap(
                        ...
                        action_items=[
                            "Enable DSAR portal via NDSEP",
                            "Create internal DSAR workflow",
                ...
                gaps.append(
                    ComplianceGap(
                        ...
                        action_items=[
                            ...
                            "Establish appropriate transfer instruments"],
                        estimated_effort="2-4 weeks",
                        impact_score=65,
                    ))
